...
/**
 * @file       ConnectivityDefines.hpp
 * @brief      Contains enumerations and structures used across various subsystems related to
 *             network connectivity.
 *
 */

#ifndef TELUX_COMMON_CONNECTIVITYDEFINES_HPP
#define TELUX_COMMON_CONNECTIVITYDEFINES_HPP
