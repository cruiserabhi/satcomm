...
#define LOGI(fmt, args...) v2x_log(LOG_INFO, "[I][%s:%d] " fmt, __func__, __LINE__, ##args)

#define LOGW(fmt, args...) v2x_log(LOG_WARNING, "[W][%s:%d] " fmt, __func__, __LINE__, ##args)

#define LOGD(fmt, args...) v2x_log(LOG_DEBUG, "[D][%s:%d] " fmt, __func__, __LINE__, ##args)

#define LOGE(fmt, args...) v2x_log(LOG_ERR, "[E][%s:%d] " fmt, __func__, __LINE__, ##args)
