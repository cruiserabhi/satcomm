...
/*
 * Steps to register listener and receive updates when MPSS state is changed are:
 *
...
class LocalMPSSStateListener : public telux::platform::ISubsystemListener {
 public:
    /* Step - 5 */
...
int main(int argc, char **argv) {
    ...
    std::shared_ptr<LocalMPSSStateListener> stateListener;
