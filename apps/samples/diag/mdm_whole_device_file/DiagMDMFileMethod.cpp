 ...
 * diagnostics logs from all the peripherals on the MDM device and save them on
 * file(s) on MDM. The steps are as follows:
 *
 ...
 *
 * Usage:
 * # ./diag_mdm_dev_file <mdm-mask-file>
 */
...
int main(int argc, char *argv[]) {
    ...
    if (argc != 2) {
        std::cout << "Usage: ./diag_mdm_dev_file <mdm-mask-file>" << std::endl;
        return -EINVAL;
    }
