...
project = 'Qualcomm Telematics SDK API Reference'
...
exhale_args = {
    "containmentFolder":     "api_rst",
    "rootFileName":          "inc_root.rst",
    "doxygenStripFromPath":  "../../include/telux",
    "rootFileTitle":         "Full Telematics SDK API",
    "createTreeView":        True,
    "exhaleExecutesDoxygen": True,
    #"exhaleDoxygenStdin":    "INPUT = ../../include/telux",
    "exhaleUseDoxyfile":     True,
    "fullToctreeMaxDepth":   1
    #"unabridgedOrphanKinds": {"define", "page"}
}
